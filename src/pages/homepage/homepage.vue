    ...
    <div class="navboxwrap">
      <div class="navbox levelbox" @click="nav('level.html')">
        <div class="levelBg">
          ...
          <span class="boxtitle">Guide</span>
        </div>
      </div>
      <div class="navbox createbox" @click="nav('blockly.html')">
        <div class="createBg">
          ...
          <span class="boxtitle">Explore</span>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      createBg, levelBg, createbgitem1, createbgitem2, createbgitem3, levelbgitem1, levelbgitem2, bg, timeoutmove: false
    }
  },
  components: { Ble },
  methods: {
